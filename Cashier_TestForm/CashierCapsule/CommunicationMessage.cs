...
{
    //make cmdtype the same as workflow
    /// <summary>
    /// 命令字定义枚举
    /// </summary>
    public enum CMDTYPE
    {
        ...
        door,
        DoorClosedMsg,               // Arduino -> PC
        DoorClosedMsgRespond,        // PC -> Arduino
        ...
        EmgMsg,                     // Arduino -> PC, when emergency happens
    ...
    public class CommunicationMessage
    {
        ...
        /// </summary>
        /// <param name="ct"></param>
        public CommunicationMessage(CMDTYPE ct)
        {
            MsgTotalLength = 5;
            MsgHeader[0] = 0xeb;
            MsgHeader[1] = 0x90;
        ...
        public CommunicationMessage(CMDTYPE MsgType, byte MsgContent)
        {
            MsgHeader[0] = 0xeb;
            MsgHeader[1] = 0x90;
            MsgHeader.CopyTo(MsgFrame, 0);
        ...
        public CommunicationMessage(ref DataPacket packet)
        {
